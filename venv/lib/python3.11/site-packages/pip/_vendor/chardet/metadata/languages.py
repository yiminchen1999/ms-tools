...
class Language:
    ...
    :type alphabet: str
    :ivar wiki_start_pages: The Wikipedia views to start from if we're crawling
...
LANGUAGES = {
    ...
    # simple way to get the Latin alphabet views from Wikipedia through
    ...
    "Vietnamese": Language(
        ...
        # dozens of 8-bit Vietnamese code views are

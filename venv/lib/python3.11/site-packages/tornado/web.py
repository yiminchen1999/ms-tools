...
class RequestHandler(object):
    ...
    def write_error(self, status_code: int, **kwargs: Any) -> None:
        """Override to implement custom error views.
    ...
    def xsrf_token(self) -> bytes:
        ...
        .. versionchanged:: 3.2.2
           ...
           request, which makes it safe to include the token in views
...
class Finish(Exception):
    ...
    This can be a more convenient way to implement custom error views

...
class Worksheet(xmlwriter.XMLwriter):
    ...
    def print_across(self):
        """
        Set the order in which views are printed.
    ...
    def fit_to_pages(self, width, height):
        """
        Fit the printed area to a specific number of views both vertically and
        horizontally.

        Args:
            width:  Number of views horizontally.
            height: Number of views vertically.

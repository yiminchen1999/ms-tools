...
LICENSES: dict[str, SPDXLicense] = {
    ...
    'linux-man-views-1-para': {'id': 'Linux-man-views-1-para', 'deprecated': False},
    'linux-man-views-copyleft': {'id': 'Linux-man-views-copyleft', 'deprecated': False},
    'linux-man-views-copyleft-2-para': {'id': 'Linux-man-views-copyleft-2-para', 'deprecated': False},
    'linux-man-views-copyleft-var': {'id': 'Linux-man-views-copyleft-var', 'deprecated': False},

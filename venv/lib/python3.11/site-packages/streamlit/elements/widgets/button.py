...
class ButtonMixin:
    ...
    def page_link(
        ...
        *,
        ...
        label : str
            The label for the page link. Labels are required for external views.
            The label can optionally contain GitHub-flavored Markdown of the
            following types: Bold, Italics, Strikethroughs, Inline Code, Links,
            and Images. Images display like icons, with a max height equal to
            the font height.
        ...
        >>> st.page_link("views/page_1.py", label="Page 1", icon="1️⃣")
        >>> st.page_link("views/page_2.py", label="Page 2", icon="2️⃣", disabled=True)

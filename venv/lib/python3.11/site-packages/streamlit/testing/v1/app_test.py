...
class AppTest:
    ...
    * |st.testing.v1.AppTest.from_function|_
    ...
    value. Switching views also requires an explicit, follow-up call to
    ``AppTest.run()``.
    ...
    def run(self, *, timeout: float | None = None) -> AppTest:
        ...
        after updating a widget value or switching views as script reruns do
    ...
    def switch_page(self, page_path: str) -> AppTest:
        ...
        page_path: str
            ...
            main script's location (e.g. ``"views/my_page.py"``).

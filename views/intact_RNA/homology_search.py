...
def main():
    ...
    mass_table = {'C':305.0413,'A':329.0525,'Oxygen':15.9949,'Me':14.01565,'2Me':28.0313,'Y':358.1599,'Na':22.989769 - 1.00784,'K':39.0983 - 1.00784,'H2O':18.01528,'K-H2O':19.94,'K+Na-2H':59.92,'2Na':43.96,'2K':75.88,'Ph':79.97079, 'CCA':2*305.0413 + 329.0525,'DIPA':101.19, '2DIPA': 2*101.19} 

...
def main():
    ...
    st.header("Homology Search for Intact RNA")
    st.text("upload the results from deconvolution, the difference between two masses will be compared with a mass table, there is a default table, user can upload a table too" )

    mass_table = {'C':305.0413,'A':329.0525,'Ox':16.0,'Me':14.01565,'2Me':28.0313,'Y':358.1599,'Na':22.989769-1.00784,'K':39.0983-1.00784,'H2O':18.01528,'Ph':79.97079,'CA':305.0413+329.0525, 'CCA':2*305.0413 + 329.0525, 'DIPA':101.19-18.01528, '2DIPA': 2*101.19-18.01528  } 
#    st.write(mass_table)
